<html>
  <head>
    <title>Freezing Nuwara-Eliya</title>
    ...
    <div class="hero">
      <div class="row">
        <div class="col">
          <div class="slider">
            <div class="product">
              <img src="nuwaraeliya1.jpg" alt="" onclick="clickme(this)" />
              <img src="nuwaraeliya2.jpg" alt="" onclick="clickme(this)" />
              <img src="nuwaraeliya3.jpg" alt="" onclick="clickme(this)" />
              <img src="Nuwara-Eliya.jpg" alt="" onclick="clickme(this)" />
            </div>
            <div class="preview">
              <img src="Nuwara-Eliya.jpg" id="imagebox" alt="" />
            </div>
          </div>
        </div>
        <div class="col">
          <div class="content">
            ...
            <p class="price">District : Nuwara-Eliya</p>
            <p style="font-size: 20px; font-weight: bold">
              Price : Rs 25,000.00 &nbsp;
              <strike style="color: red; font-size: 15px">Rs 30,000.00</strike>
            </p>
            <br />
    ...
    <table>
        <tr>
            ...
            <ul>
                ...
                <li>St. Clair’s Falls</li>
                <li>Town Walk</li>
                <li>Hakgala Botanical Garden</li>
                <li>Thotupola Kanda</li>
                <li>Gregory Lake</li>
                <li>Horton Plains National Park</li>
            </ul>
            <p class="tags"><i class="fa fa-bed"></i> Lounging : <br></p> 
            <a href="https://www.agoda.com/nuwara-eliya-hills-rest/hotel/nuwara-eliya-lk.html?cid=1844104" class="link" > Nuwara Eliya Hills Rest</a>
