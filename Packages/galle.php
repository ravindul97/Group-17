<html>
  <head>
    <title>Amazing Down south</title>
    ...
    <div class="hero">
      <div class="row">
        <div class="col">
          <div class="slider">
            <div class="product">
              <img src="galle1.jpg" alt="" onclick="clickme(this)" />
              <img src="galle2.jpg" alt="" onclick="clickme(this)" />
              <img src="galle3.jpg" alt="" onclick="clickme(this)" />
              <img src="downsouth.jpg" alt="" onclick="clickme(this)" />
            </div>
            <div class="preview">
              <img src="downsouth.jpg" id="imagebox" alt="" />
            </div>
          </div>
        </div>
        <div class="col">
          <div class="content">
            ...
            <p class="price">District : Galle / Mathara / Hambanthota</p>
      ...
      <div class="related">
        ...
        <div class="row">
          ...
          <div class="columns">
            <div class="items">
              <a href="kandy.html" style="text-decoration: none;"><img src="kandy.jpg" alt="" />
    ...
    <table>
        <tr>
            ...
            <ul>
              ...
              <li>Kataragama Temple</li>
              <li>Hambanthota Dry zone park</li>
              <li>Hambanthota birds park</li>
              <li>Giragama Tea Plantations</li>
              <li>Galle town tour</li>
              <li>Kosgoda Turtle Care</li>
              <li>Galle Fort – Galle</li>
            </ul>
            <p class="tags"><i class="fa fa-bed"></i> Lounging : <br></p> 
            <a href="http://dumbara-peak-residence.kandy-hotels.com/en/" class="link" > Mirissa park hotel</a>
