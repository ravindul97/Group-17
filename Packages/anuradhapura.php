<html>
  <head>
    <title>Ancient Anuradhapura</title>
  ...
  <body>
    <div class="hero">
      <div class="row">
        <div class="col">
          <div class="slider">
            <div class="product">
              <img src="anuradhapura1.jpg" alt="" onclick="clickme(this)" />
              <img src="anuradhapura2.jpg" alt="" onclick="clickme(this)" />
              <img src="anuradhapura3.jpg" alt="" onclick="clickme(this)" />
              <img src="anuradhapura.jpg" alt="" onclick="clickme(this)" />
            </div>
            <div class="preview">
              <img src="anuradhapura.jpg" id="imagebox" alt="" />
            </div>
          </div>
        </div>
        <div class="col">
          <div class="content">
            ...
            <p class="price">District : Anuradhapura</p>
    ...
    <table>
        <tr>
            ...
            <ul>
                <li> Sri Maha Bodhiya</li>
                <li>Ruwanweliseya</li>
                <li>Minneriya National Park</li>
                <li>Anuradhapura tank tour</li>
                <li>Baswakkulama tank bath</li>
                <li>Ambuluwawa tower</li>
                <li>ancient city tour</li>
                <li>Polonnaruwa Gal Viharaya</li>
            </ul>
            <p class="tags"><i class="fa fa-bed"></i> Lounging : <br></p> 
            <a href="https://saliyagarden.com" class="link" > Hotel 4 U Saliya garden</a>
