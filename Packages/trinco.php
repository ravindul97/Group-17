    ...
    <div class="hero">
      <div class="row">
        <div class="col">
          <div class="slider">
            <div class="product">
              <img src="trinco1.jpg" alt="" onclick="clickme(this)" />
              <img src="trinco2.jpg" alt="" onclick="clickme(this)" />
              <img src="trinco3.jpg" alt="" onclick="clickme(this)" />
              <img src="trinco.jpg" alt="" onclick="clickme(this)" />
            </div>
            <div class="preview">
              <img src="trinco.jpg" id="imagebox" alt="" />
            </div>
          </div>
        </div>
        <div class="col">
          <div class="content">
            ...
            <p class="price">District : Trincomalee</p>
            <p style="font-size: 20px; font-weight: bold">
              Price : Rs 15,500.00 &nbsp;
              <strike style="color: red; font-size: 15px">Rs 22,300.00</strike>
            </p>
            <br />
      ...
      <div class="related">
        ...
        <div class="row">
          ...
          <div class="columns">
            <div class="items">
              <a href="kandy.html" style="text-decoration: none;"><img src="kandy.jpg" alt="" /></a>
    ...
    <table>
        <tr>
            ...
            <ul>
                ...
                <li>Fort Frederick</li>
                <li> Pathirakali Amman Temple</li>
                <li>Velgam Vehera</li>
                <li>Maritime and Naval History Museum</li>
                <li> Uppuveli & Nilaveli Beaches</li>
                <li>Trincomalee War Cemetery</li>
                <li>Pigeon Island National Park</li>
            </ul>
            <p class="tags"><i class="fa fa-bed"></i> Lounging : <br></p> 
            <a href="https://www.agoda.com/elegant-green-beach-resort-h16360327/hotel/trincomalee-lk.html?cid=1844104" class="link" > Elegant green beach resort</a>
