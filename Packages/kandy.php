  ...
  <body>
    <div class="hero">
      <div class="row">
        <div class="col">
          <div class="slider">
            <div class="product">
              <img src="kandy4.jpg" alt="" onclick="clickme(this)" />
              <img src="kandy1.jpg" alt="" onclick="clickme(this)" />
              <img src="kandy2.jpg" alt="" onclick="clickme(this)" />
              <img src="kandy3.jpg" alt="" onclick="clickme(this)" />
            </div>
            <div class="preview">
              <img src="kandy5.jpg" id="imagebox" alt="" />
            </div>
          </div>
        </div>
        <div class="col">
          <div class="content">
            ...
            <p class="price">District : Kandy</p>
            <p style="font-size: 20px; font-weight: bold">
              Price : Rs 15,000.00 &nbsp;
              <strike style="color: red; font-size: 15px">Rs 20,000.00</strike>
            </p>
            <br />
    ...
    <table>
        <tr>
            ...
            <ul>
              <li>The Temple of the Sacred Tooth Relic</li>
              <li>Kandy City Tour</li>
              <li>Peradeniya Botanical Gardens</li>
              <li>Lankatilaka Vihara Temple</li>
              <li>Giragama Tea Plantations</li>
              <li>Ambuluwawa tower</li>
              <li>Gadaladeniya Vihara Temple</li>
              <li>Knuckles Mountain Range</li>
            </ul>
            <p class="tags"><i class="fa fa-bed"></i> Lounging : <br></p> 
            <a href="http://dumbara-peak-residence.kandy-hotels.com/en/" class="link" > Dumbara peak Residence</a>
